...
final class SetCollections_1_6Tests: XCTestCase {
    ...
    func testLettersOne(){
        ...
        let notMatch = "anstu"
        let uniqueText1 = "ant"
        let test1 = setModel.allMtchingLetters(text1: text1, text2: text2)
        let test2 = setModel.noMtchingLetters(text1: text1, text2: text2)
    ...
    func testLettersTwo(){
        let text1 = "real"
        let text2 = "Ant"
        let test = setModel.allMtchingLetters(text1: text1, text2: text2)
